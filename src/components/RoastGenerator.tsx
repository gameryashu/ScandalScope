...
import { Zap, Settings, History, TrendingUp } from 'lucide-react';
...
export const RoastGenerator: React.FC<RoastGeneratorProps> = ({
  ...
  const handleRoastGenerated = (roast: RoastResult) => {
    // Handle roast generation completion
    console.log('Roast generated:', roast);
  };

  const handleRegenerate = async () => {
    await regenerateRoast();
  };
